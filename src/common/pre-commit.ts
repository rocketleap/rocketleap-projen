...
export const CDK_PRE_COMMIT_HOOKS: PreCommitHook[] = [
  { id: 'yarn-clean', name: 'Clean', entry: 'sh -c "CI=true yarn clean"', passFilenames: false },
  { id: 'yarn-package', name: 'Packages', entry: 'sh -c "CI=true yarn"', passFilenames: false },
  {
    id: 'projen',
    name: 'projen',
    entry: 'sh -c "npx projen && git diff --exit-code"',
    passFilenames: false,
  },
  {
    id: 'yarn-format',
  ...
  { id: 'yarn-lint', name: 'Lint', entry: 'sh -c "CI=true yarn lint:ci"', passFilenames: false },
  { id: 'yarn-build', name: 'Build', entry: 'sh -c "CI=true yarn build"', passFilenames: false },
  { id: 'yarn-test', name: 'Tests', entry: 'sh -c "CI=true yarn test:ci"', passFilenames: false },
];
