...
abstract class RocketleapBaseCdkProject extends awscdk.AwsCdkTypeScriptApp {
  ...
  protected constructor(options: RocketleapCdkProjectOptions) {
    ...
    super({
      ...
      // Use yarn for the projen command (projen default is `npx projen`).
      // Fixes the "Generated by projen" marker and the package.json
      // `projen` script. `projenrcTs: true` is already set via
      // SWC_CONFIGURATION spread below.
...
export class RocketleapLibraryCdkProject extends typescript.TypeScriptProject {
  constructor(options: RocketleapLibraryCdkProjectOptions) {
    ...
    super({
      ...
      // Use yarn for the projen command (default is `npx projen`).
      // `projenrcTs: true` comes from SWC_CONFIGURATION spread below.
      projenCommand: 'yarn projen',
