...
abstract class RocketleapBaseCdkProject extends awscdk.AwsCdkTypeScriptApp {
  ...
  protected constructor(options: RocketleapCdkProjectOptions) {
    ...
    super({
      ...
      // Rocketleap CDK projects follow the eight canonical stacks, not the
      // single-`main.ts` shape projen's AwsCdkTypeScriptApp samples produce.
      // `.projenrc.ts` is still generated by `generateSampleProjenrc`.
      sampleCode: false,
