...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@rocketleap/rocketleap-projen.GitHubSettingsOptions.property.defaultBranch">defaultBranch</a></code> | <code>string</code> | Default branch name. |
| <code><a href="#@rocketleap/rocketleap-projen.GitHubSettingsOptions.property.description">description</a></code> | <code>string</code> | Repository description surfaced on the GitHub repo page. |
| <code><a href="#@rocketleap/rocketleap-projen.GitHubSettingsOptions.property.requiredApprovingReviewCount">requiredApprovingReviewCount</a></code> | <code>number</code> | Number of approving reviews required before the default branch accepts a merge. |
| <code><a href="#@rocketleap/rocketleap-projen.GitHubSettingsOptions.property.requiredStatusChecks">requiredStatusChecks</a></code> | <code>string[]</code> | Status check contexts required to pass before the default branch accepts a merge. |

---

##### `defaultBranch`<sup>Optional</sup> <a name="defaultBranch" id="@rocketleap/rocketleap-projen.GitHubSettingsOptions.property.defaultBranch"></a>
...
##### `description`<sup>Optional</sup> <a name="description" id="@rocketleap/rocketleap-projen.GitHubSettingsOptions.property.description"></a>
...
##### `requiredApprovingReviewCount`<sup>Optional</sup> <a name="requiredApprovingReviewCount" id="@rocketleap/rocketleap-projen.GitHubSettingsOptions.property.requiredApprovingReviewCount"></a>
...
Number of approving reviews required before the default branch accepts a merge.

---

##### `requiredStatusChecks`<sup>Optional</sup> <a name="requiredStatusChecks" id="@rocketleap/rocketleap-projen.GitHubSettingsOptions.property.requiredStatusChecks"></a>

```typescript
public readonly requiredStatusChecks: string[];
```

- *Type:* string[]
- *Default:* no required status checks

Status check contexts required to pass before the default branch accepts a merge.
